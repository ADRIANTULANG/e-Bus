              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        AdminHomeScreenDialog.showDialogForMonetization(
                    ...
                    InkWell(
                      onTap: () {
                        AdminHomeScreenDialog.showDialogAccountSettings(
                            controller: controller);
                      },
                      child: Container(
                        padding: EdgeInsets.all(1.w),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: QrImage(
                                        padding: EdgeInsets.all(1.w),
                                        data: controller.ticketsList[0].transId
                                            .toString(),
